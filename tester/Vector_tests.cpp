...
void vector_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        /*---------------------------------- time limit test --------------------------------------------*/
        {
            ...
            ft::vector<std::string> vf(1e5, "range constructor test");
            start = get_time();
            ...
            ualarm(diff * 1e3, 0);
            ft::vector<std::string> my_v(vf.begin(), vf.end());
            ualarm(0, 0);
        }
        /*-----------------------------------------------------------------------------------------------*/
              ...
              << "] --------------------]\t\t\033[0m";
    {
        /*-------------------------------------- time limit test -----------------------------------*/
        {
            ...
            /*------------------ std::vectors ---------------------*/
            {
                ...
                ft::vector<std::string> vf(1e5, "hello");
                std::vector<std::string> v1(1e6, "string2");
                start = get_time();
                v1.insert(v1.begin() + 1e5, v.begin(), v.end());
                end = get_time();
                ...
                ft::vector<std::string> ft_v1(1e6, "string2");
                ualarm(diff * 1e3, 0);
                ft_v1.insert(ft_v1.begin() + 1e5, vf.begin(), vf.end());
                ualarm(0, 0);
            }
            /*--------------------------------------------------------------------------------------*/
        }
        ...
        // insert at the begin
        {
            ...
            ft::vector<std::string> vf1(300, "string");
            std::vector<std::string> v;
            ft::vector<std::string> ft_v;
            v.insert(v.begin(), v1.begin(), v1.end());
            ft_v.insert(ft_v.begin(), vf1.begin(), vf1.end());
            ft_v.begin()->length();
        ...
        // insert at the end
        {
            ...
            ft_v.insert(ft_v.end(), vf1.begin(), vf1.end());
            ft_v.begin()->length();
        ...
        /*------------------------------- test 2: the vector capacity >= size + n ----------------------------------------*/
        {
            ...
            ft::vector<std::string> vf1(70, "hello");
            std::vector<std::string> v(20, "string");
            ft::vector<std::string> ft_v(20, "string");
            ft::vector<std::string>::iterator valid_it;
            ...
            ft_v.insert(ft_v.begin() + 15, vf1.begin(), vf1.end());
        ...
        /*------------------------------- test 3: the vector capacity < size + n && n > size ----------------------------------------*/
        {
            ...
            ft::vector<std::string> vf1(100, "hello");
            std::vector<std::string> v(20, "string");
            ft::vector<std::string> ft_v(20, "string");

            v.insert(v.begin() + 10, v1.begin(), v1.end());
            ft_v.insert(ft_v.begin() + 10, vf1.begin(), vf1.end());
        ...
        /*------------------------------- test 4: the vector capacity < size + n && n <= size ----------------------------------------*/
        {
            ...
            ft::vector<std::string> vf1(15, "hello");
            std::vector<std::string> v(20, "string");
            ft::vector<std::string> ft_v(20, "string");
