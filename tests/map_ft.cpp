...
int main()
{
    ...
    std::cout << "begin & end: " << std::endl << std::endl;
    {
        ft::map<int, int> mp;
         for (int i = 0; i < 7; i ++) {
            mp.insert(ft::make_pair((i + 1) * 13, (i + 1)* 37));
        }
        mp.insert(ft::make_pair(13, 89));
    ...
    std::cout << std::endl << "erase & find: " << std::endl << std::endl;
    {
        ...
        ft::map<std::string, int>::iterator it = mp.find("c");
    ...
    std::cout << std::endl << "get_allocator: " << std::endl << std::endl;
    {
        int psize;
        ft::map<std::string, int> mp;
        ft::pair<const std::string, int> *pointer;

        pointer = mp.get_allocator().allocate(7);

        psize = sizeof(ft::map<std::string, int>::value_type) * 7;
    ...
    std::cout << std::endl << "insert: " << std::endl << std::endl;
    {
        ...
        mp.insert( ft::pair<std::string, int>("z",800) );
        mp.insert( ft::pair<std::string, int>("t", 600) );

        ft::pair<ft::map<std::string, int>::iterator, bool> ret;

        ret = mp.insert( ft::pair<std::string, int> ("x", 700) );
        ...
        mp.insert(it, ft::pair<std::string, int>("a", 100));
        mp.insert(it, ft::pair<std::string, int>("m", 500));
    ...
    {
        ft::map<std::string, int> mp;
        ft::map<std::string, int>::key_compare cmp = mp.key_comp();
    ...
    {
        ft::map<std::string, int>::iterator itlow, itupp;
        ft::map<std::string, int> mp;
        mp["a"] = 100;
        mp["c"] = 200;
        mp["z"] = 300;
    ...
    std::cout << std::endl << "swap: " << std::endl << std::endl;
    {
        ...
        for (ft::map<std::string, int>::iterator it = sec.begin(); it != sec.end(); it++)
            std::cout << "key: " << it->first << ", value: " << it->second << std::endl;
        std::cout << std::endl;
    }
    // value_comp
    std::cout << std::endl << "value_comp: " << std::endl << std::endl;
    {
        ...
        ft::map<std::string, int>::value_compare vcmp = mp.value_comp();
